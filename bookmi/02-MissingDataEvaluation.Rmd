...
```{r}
#aggr_pattern <- aggr(dataset[, -1], col=c('white','red'), numbers=TRUE, sortVars=TRUE, labels=names(dataset[, -1]), cex.axis=.7, gap=3, 
...
```{r fig7, echo = FALSE, fig.cap="Examples of MCAR, MAR and MNAR data.", out.width='90%', fig.align='center'}
...
```{r tab3, echo = FALSE, fig.cap="MAR missing data in the Tampa scale variable.", out.width='90%', fig.align='center'}
...
```{r fig8, echo = FALSE, fig.cap="The missing data in the Tampa scale variable coded according to the missing data indicator variable R.", out.width='90%', fig.align='center'}
...
```{r fig9a, echo = FALSE, fig.cap="MCAR", out.width='90%', fig.align='center'}
...
```{r fig9b, echo = FALSE, fig.cap="MAR", out.width='90%', fig.align='center'}
...
```{r fig9c, echo = FALSE, fig.cap="MNAR", out.width='90%', fig.align='center'}
...
> The MCAR assumption is mostly very strict and not realistic in practice.

> The MAR assumption is more realistic and mostly assumed in practice.

> The difference bewteen MAR and MNAR is that in MNAR the probability of missingness is also related to the unobserved (missing) data.
...
To get descriptive information of variables with missing data we again make use of the options under Missing Value Analysis (MVA) in SPSS, more specific from the possibilities under “Descriptive”. To find these, from the menus choose: Analyze -> Missing Value Analysis... than transfer all variables in the correct Quantitative and Categorical variables window and then choose for Descriptives option  -> Univariate statistics. 

```{r fig10, echo = FALSE, fig.cap="Missing value Analysis menu in SPSS", out.width='90%', fig.align='center'}
...
```{r fig11, echo = FALSE, fig.cap="The T-test procedure as part of the Missing Value Analysis menu", out.width='90%', fig.align='center'}
...
```{r fig12, echo = FALSE, fig.cap="EM selection in the Missing Value Analysis menu.", out.width='90%', fig.align='center'}
...
Little´s MCAR test is available in the BaylorEdPsych package for R as the LittleMCAR function. To apply the test, we take a subset of only the continuous variables. An example is given in R code 2.9 were we use the dataset of 150 low back pain patients with missing data in the Tampa scale and Disability variable.

```{r}
#dataset <- dataset[, c("Pain", "Tampascale", "Disability", "Age")]
#LittleMCAR(dataset)
