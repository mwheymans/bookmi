...
There are two factors important when multilevel imputation models are used. At which level are the missing values located, which determines the imputation method and how to design the predictormatrix. We start with explaining how to design the predictormatrix.
