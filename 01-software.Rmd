...
We start the book with an introduction of the software packages SPSS and R(Studio). If you are an SPSS user and does not have experience with R(Studio) we recommend to read the parts about R(Studio) before you continue to the next chapters. If you are an RStudio user and you do not want to learn SPSS, you can skip this Chapter without losing relevant information and continue with the next chapter.
