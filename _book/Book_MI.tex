...
\begin{verbatim}
##  [1] -0.95847731 -0.17356074 -0.12484300  0.02401969 -0.13135366
##  [6]  1.83389436  0.32743919 -0.57013965 -0.69174803 -0.27788227
## [11]  0.15714686 -1.31862784  1.03404659 -0.35383865  0.75897016
## [16] -0.12228334  1.57351315 -0.38836910 -0.80311968 -1.14752171
\end{verbatim}
...
\tightlist
\item
  Import datasets via ``Import Dataset'' An easy is via the window at
  the right site above. There you will find the button ``Import
...
\emph{Write.table} You can use the write.table function to write
matrices and data frames (datasets):

Files are written with write.table can be easily imported in SPSS by
using the steps that will be discussed in the next paragraph.

\emph{Read.table} You can use the read.table function to read in
...
Then click finish and the data will be imported in a new SPSS file. In
...
continuous variables (\citet{rubin1987}). The strength of this procedure
is that missing data is replaced by data that is observed in the dataset
and not replaced by unrealistic values (as negative body weight values).
